instance_destroy(Obj_Bnao)
instance_destroy(Obj_Bsim)
...
instance_create_depth(Obj_player.x-100,Obj_player.y+130,depth -1,Obj_Bsim)
instance_create_depth(Obj_player.x+90,Obj_player.y+130,depth -1,Obj_Bnao)
